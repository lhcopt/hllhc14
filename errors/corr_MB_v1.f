...
ccccc 2011/11/22 from SLHCV3.0 of 2011/07/27
	  ...
	  real*8 b2aux(2,8,Ns_MB*154),a2aux(2,8,Ns_MB*154),a3aux(2,8,Ns_MB*154)
...
c	  alpha=twopi/1232.
	  ...
	  do while(.true.)
	  read(1,*,err=99,end=100) chardum,alpha,k1lmqt,betx,bety,dx,amux,amuy
             aux1=sqrt(betx*bety)
 ...
 100         continue
      ...
      write(6,'(i4,1x,a30,1x,i1)') imqtf(i),' MQTD slices in sector ', i
